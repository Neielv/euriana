    ...
    {    
        ...
        if ($this->tipo_reporte==3)
        {
            $datos=Pedido::Where('pedidos.created_at','>=',$this->fecha_desde)
                ...
                ->selectRaw('productos.stock as existencia')
                ->selectRaw('productos.stock_minimo as minimo')
                ...
                ->groupBy('productos.codigo','productos.stock','productos.stock_minimo','productos.nombre','productos.id')
                ->get();
        }
